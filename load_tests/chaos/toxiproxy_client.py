...
class ToxiproxyClient:
    ...
    def simulate_connection_timeout(self, proxy_name: str, name: str = None) -> Dict:
        ...
        return self.add_toxic(
            ...
            ToxicType.TIMEOUT,
            {"timeout": 0},  # 0 = 무한 대기
            name=name or f"{proxy_name}_timeout"
        )
    ...
    def simulate_latency(
        ...
        return self.add_toxic(
            ...
            name=name or f"{proxy_name}_latency"
        )
    ...
    def simulate_connection_reset(
        ...
        return self.add_toxic(
            ...
            {"timeout": 0},
            name=name or f"{proxy_name}_reset",
            toxicity=probability
        )
    
    def simulate_bandwidth_limit(
        self,
        proxy_name: str,
        rate_kb: int,
        name: str = None
        ...
        return self.add_toxic(
            ...
            ToxicType.BANDWIDTH,
            {"rate": rate_kb},
            name=name or f"{proxy_name}_bandwidth"
        )

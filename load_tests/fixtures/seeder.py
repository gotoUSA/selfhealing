    ...
    def seed_products(self, count: Optional[int] = None) -> List[dict]:
        ...
        for i in range(count):
            product_data = {
                ...
                "price": random.randint(self.config.product_price_min, self.config.product_price_max),
                "stock": random.randint(self.config.product_stock_min, self.config.product_stock_max),

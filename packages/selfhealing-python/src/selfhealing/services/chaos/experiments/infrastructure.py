    ...
    def rollback(self) -> None:
        ...
        with self._rollback_lock:
            if self._rollback_completed:
                logger.info(f"[CertificateExpiry] Rollback already completed")
                return
...
class ClockSkewExperiment(ChaosExperiment):
    ...
    def rollback(self) -> None:
        ...
        with self._rollback_lock:
            if self._rollback_completed:
                logger.info(f"[ClockSkew] Rollback already completed")
                return
...
class DNSFailureExperiment(ChaosExperiment):
    ...
    def rollback(self) -> None:
        ...
        with self._rollback_lock:
            if self._rollback_completed:
                logger.info(f"[DNSFailure] Rollback already completed")
                return
...
class SimulatedDiskIOExperiment(ChaosExperiment):
    ...
    def rollback(self) -> None:
        ...
        with self._rollback_lock:
            if self._rollback_completed:
                logger.info(f"[SimulatedDiskIO] Rollback already completed")
                return
...
class SimulatedTLSFailureExperiment(ChaosExperiment):
    ...
    def rollback(self) -> None:
        ...
        with self._rollback_lock:
            if self._rollback_completed:
                logger.info(f"[SimulatedTLS] Rollback already completed")
                return

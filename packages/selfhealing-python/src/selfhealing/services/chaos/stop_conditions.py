...
class StopConditionsChecker:
    ...
    def __init__(
        self,
        config: StopConditionsConfig | None = None,
    ...
    def check(
        ...
        should_stop = (
            len(violations) > 0
            and consecutive_count >= self._config.consecutive_breaches_required
        )
...
_stop_conditions_checker: StopConditionsChecker | None = None

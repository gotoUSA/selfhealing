...
def log_panic_threshold_audit(
    ...
    open_count: int,
    total_count: int,
    open_circuits: list | None = None,
    action_taken: str = "emergency_level_3_escalation",
    halted_systems: list | None = None,
...
def _extract_trace_id(provided_trace_id: str | None) -> str | None:
...
def _extract_actor_roles(provided_roles: list | None) -> list:
...
def log_error_budget_blocked_audit(
    ...
    reason: str | None = None,
    request: Any = None,
    blocked_request_trace_id: str | None = None,

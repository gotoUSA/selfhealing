...
class PartitionStatus:
    ...
    global_redis_url: Optional[str] = None
...
class PartitionReconciliationService:
    ...
    def __init__(
        ...
        tiered_redis: Optional[Any] = None,
        ...
        self._partition_start: Optional[datetime] = None
    ...
    def get_partition_duration(self) -> Optional[float]:
        """
        현재 고립 지속 시간 (초).

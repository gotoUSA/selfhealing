...
class GradientCalculator:
    ...
    def __init__(
        ...
        self._previous_smoothed_rtt: Optional[float] = None
...
_global_adaptive_throttle: Optional[AdaptiveThrottle] = None
_throttle_lock = threading.Lock()


def get_adaptive_throttle(config: Optional[ThrottleConfig] = None) -> AdaptiveThrottle:
    """

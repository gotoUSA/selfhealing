...
class ShadowBudgetCalculator:
    ...
    def __init__(
        self,
        get_error_logs: Callable[[datetime, datetime], list[dict]] | None = None,
        get_prometheus_errors: Callable[[datetime, datetime], int] | None = None,
        get_dlq_entries: Callable[[datetime, datetime], int] | None = None,
    ):
        """
        초기화.
    ...
    def calculate_shadow_budget(
        ...
        errors_by_severity: dict[str, int] | None = None,
        domain: str = "unknown",

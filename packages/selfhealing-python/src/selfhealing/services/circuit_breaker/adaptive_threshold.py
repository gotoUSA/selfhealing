...
class AdaptiveThresholdManager:
    ...
    def __init__(
        ...
        emergency_manager: Optional["EmergencyModeManager"] = None,
    ):
        """
    ...
    def emergency_manager(self):
        ...
        if self._emergency_manager is None:
            try:
                ...
                logger.warning(
                    "[AdaptiveThreshold] EmergencyModeManager not available, "
                    "using NORMAL level"
                )
    ...
    def should_allow_auto_open(
        ...
        if threshold.is_lockdown:
            return False, f"LOCKDOWN: Auto OPEN blocked - {threshold.multiplier.description}"
    ...
    def should_allow_auto_close(
        ...
        if threshold.is_lockdown:
            return False, f"LOCKDOWN: Auto CLOSE blocked - Freeze Mode active"
...
_manager_instance: Optional[AdaptiveThresholdManager] = None
...
def should_allow_cb_auto_open(service_id: Optional[str] = None) -> bool:
    """

...
class ActionableAlertUrlBuilder:
    ...
    def _build_dashboard_url(self, service_name: str) -> Optional[str]:
        """
        Grafana 대시보드 URL 생성.
    ...
    def _build_runbook_url(self, context: Optional[str] = None) -> Optional[str]:
        """
        Runbook URL 생성.
...
_instance: Optional[ActionableAlertUrlBuilder] = None

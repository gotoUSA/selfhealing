...
class RecoveryCircuitBreaker:
    ...
    def __init__(
        self,
        config: Optional[RecoveryCircuitBreakerConfig] = None,
        metrics_provider: Optional[Callable[[str], RecoveryMetricsSnapshot]] = None,
    ):
        """
        Args:
            config: 회로 차단기 설정
        ...
        self._snapshots: Dict[str, List[RecoveryMetricsSnapshot]] = {}  # 메트릭 히스토리
    ...
    def check_and_trip(
        self,
        namespace: str,
        snapshot: Optional[RecoveryMetricsSnapshot] = None,
    ) -> Dict[str, Any]:
        """
        메트릭 확인 및 필요시 회로 차단.
    ...
    def reset(self, namespace: str) -> None:
        ...
        with self._lock:
            ...
            logger.info(
                f"[RecoveryCircuitBreaker] Reset: namespace={namespace}"
            )
    ...
    def _trip(self, namespace: str, reason: str) -> Dict[str, Any]:
        ...
        should_re_escalate = (
            self._config.re_escalation_enabled and not is_permanent
        )
        ...
        return {
            ...
            "re_escalation_level": self._config.re_escalation_level if should_re_escalate else None,
            "trip_count": trip_count,
    ...
    def _cleanup_old_snapshots(self, namespace: str) -> None:
        ...
        self._snapshots[namespace] = [
            s for s in self._snapshots[namespace]
...
_recovery_circuit_breaker: Optional[RecoveryCircuitBreaker] = None

...
class RecoveryAuditRecorder:
    ...
    def __init__(
        self,
        notification_callback: Optional[Callable[[DangerousForceRecoveryAuditEntry], None]] = None,
    ):
        """
        Args:
    ...
    def _persist_force_recovery_entry(self, entry: DangerousForceRecoveryAuditEntry) -> None:
    ...
    def get_force_recovery_history(
        ...
        try:
            ...
            entries = [
                DangerousForceRecoveryAuditEntry.from_dict(d)
                for d in data[-limit:]
            ]
    ...
    def get_recent_events(
        ...
        event_types: Optional[List[RecoveryAuditEventType]] = None,
        limit: int = 100,
        ...
        if event_types:
            type_values = {t.value if isinstance(t, RecoveryAuditEventType) else t for t in event_types}
...
_recovery_audit_recorder: Optional[RecoveryAuditRecorder] = None

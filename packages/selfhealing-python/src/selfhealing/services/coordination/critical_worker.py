...
class CriticalPathDedicatedWorkerConfig:
    ...
    # P3 알림 태스크
    notification_tasks: Set[str] = field(default_factory=lambda: {
    ...
    # P4+ 유지보수 태스크
    maintenance_tasks: Set[str] = field(default_factory=lambda: {
...
_worker_config: Optional[CriticalPathDedicatedWorkerConfig] = None

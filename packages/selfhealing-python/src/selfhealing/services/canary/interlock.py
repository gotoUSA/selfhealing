...
class InterlockResult:
    ...
    def rollback(
        ...
        return cls(
            ...
            allowed=False,
            reason=reason
            or f"Emergency {emergency_level_name} requires immediate rollback",
            emergency_level=emergency_level,
            emergency_level_name=emergency_level_name,
            namespace=namespace,
        )
...
class CanarySafetyInterlock:
    ...
    def __init__(
        self,
        policy: dict[int, InterlockAction] | None = None,
...
_safety_interlock: CanarySafetyInterlock | None = None

...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "CircuitBreakerState": ("selfhealing.audit.resilience", "CircuitBreakerState"),
    ...
    "get_inmemory_audit_buffer": ("selfhealing.audit.resilience", "get_inmemory_audit_buffer"),
...
if TYPE_CHECKING:
    from selfhealing.audit.logger import ConfigChangeEvent, AuditAction
    from selfhealing.audit.masking import mask_sensitive_fields, extract_ip_from_request
    from selfhealing.audit.trace import TraceContext, trace_id_middleware
    from selfhealing.audit.integrity import HashChainVerifier, verify_audit_log_integrity

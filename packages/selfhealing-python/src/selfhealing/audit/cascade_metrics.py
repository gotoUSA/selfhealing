...
class CascadeMetrics:
    ...
    def to_prometheus_format(self) -> str:
        ...
        with self._metrics_lock:
            ...
            lines.append(
                "# HELP selfhealing_cascade_events_total Total cascade events recorded"
            )
            ...
            lines.append(
                "# HELP selfhealing_cascade_effects_total Total cascade effects recorded"
            )
            ...
            lines.append(
                "# HELP selfhealing_cascade_chain_depth_max Maximum chain depth recorded"
            )
            ...
            lines.append(
                "# HELP selfhealing_cascade_integrity_valid Hash chain integrity status (1=valid)"
            )
            ...
            lines.append(
                "# HELP selfhealing_cascade_load_shedding_dropped_total Events dropped by load shedding"
            )
            lines.append(
                "# TYPE selfhealing_cascade_load_shedding_dropped_total counter"
            )
            ...
            lines.append(
                "# HELP selfhealing_cascade_fallback_writes_total Total fallback writes"
            )

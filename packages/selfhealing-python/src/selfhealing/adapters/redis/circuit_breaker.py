...
class RedisCircuitBreakerStateRepository(CircuitBreakerStateRepository):
    ...
    def update_state(
        ...
        half_open_request_count: Optional[int] = None,
    ) -> bool:
        """
    ...
    def increment_failure(self, service_name: str) -> int:
        ...
        now = datetime.now(timezone.utc)
        self._backend.hset(self._make_key(service_name), {
...
# Singleton
_redis_cb_repo: Optional[RedisCircuitBreakerStateRepository] = None

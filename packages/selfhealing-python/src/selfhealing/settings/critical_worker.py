...
Environment Variables:
    SELFHEALING_CRITICAL_WORKER_CRITICAL_QUEUE_NAME=selfhealing.critical
    SELFHEALING_CRITICAL_WORKER_CRITICAL_WORKER_COUNT=2
    SELFHEALING_CRITICAL_WORKER_DEPLOYMENT_ENV=STANDARD
    SELFHEALING_CRITICAL_WORKER_POOL_MINIMAL_WORKER_COUNT=2
    SELFHEALING_CRITICAL_WORKER_POOL_STANDARD_WORKER_COUNT=4
    SELFHEALING_CRITICAL_WORKER_POOL_HIGH_AVAILABILITY_WORKER_COUNT=4
    SELFHEALING_CRITICAL_WORKER_POOL_BURST_WORKER_COUNT=2
...
class CriticalWorkerSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="SELFHEALING_CRITICAL_WORKER_",
        env_file=".env",

...
_synthetic_session_id: ContextVar[Optional[str]] = ContextVar(
...
class TestModeContext:
    ...
    _token_synthetic: Optional[Token[bool]] = None
    _token_session: Optional[Token[Optional[str]]] = None
...
def get_synthetic_session_id() -> Optional[str]:

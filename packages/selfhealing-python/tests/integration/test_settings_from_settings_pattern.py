...
7. CircuitBreakerConfig.from_settings()
...
class TestGracefulDegradationFromSettings:
    """FallbackConfig/CircuitBreakerConfig.from_settings() 동작 검증."""
    ...
    def test_circuit_breaker_config_default_values(self):
        """CircuitBreakerConfig 기본값으로 인스턴스 생성."""
        from selfhealing.audit.graceful_degradation.enums import CircuitBreakerConfig
...
class TestFromSettingsPatternConsistency:
    ...
    def test_all_from_settings_return_correct_type(self):
        ...
        assert isinstance(CircuitBreakerConfig.from_settings(), CircuitBreakerConfig)

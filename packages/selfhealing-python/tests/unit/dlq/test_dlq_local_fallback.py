...
from selfhealing.services.dlq.models import DLQConfig, DLQEntryResult
...
class TestDLQEntryResultFallback:
    ...
    def test_is_fallback_true_when_fallback_path_set(self):
        ...
        result = DLQEntryResult.fallback(error="DB failed", fallback_path="/tmp/dlq_fallback.jsonl")

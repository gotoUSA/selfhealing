...
class TestXTestRegionalBoundary:
    ...
    def test_check_chaos_permission_includes_regional_check(self, mixin, mock_global_request):
    ...
    def test_check_chaos_permission_cross_region_denied(self, mixin, mock_global_request):
    ...
    def test_check_chaos_permission_same_region_allowed(self, mixin, mock_global_request):

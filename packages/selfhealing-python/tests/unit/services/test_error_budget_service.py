...
class TestFreezeDecisionRecorder:
    ...
    def test_record_freeze_acknowledged(self):
        ...
        record = recorder.record_freeze_acknowledged(
            decided_by="admin",
            justification="Critical situation"
        )
    ...
    def test_record_freeze_lifted(self):
        ...
        record = recorder.record_freeze_lifted(
            decided_by="admin",
            justification="Budget recovered"
        )
...
class TestErrorBudgetService:
    ...
    def test_full_workflow(self):
        ...
        ack_record = service.acknowledge_freeze(
            decided_by="ops_lead",
            justification="Acknowledging freeze recommendation"
        )
        ...
        # 5. Lift freeze
        lift_record = service.lift_freeze(
            decided_by="ops_lead",
            justification="Situation resolved"
        )

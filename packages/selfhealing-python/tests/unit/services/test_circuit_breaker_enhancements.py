...
class TestMinimumCalls:
    ...
    def test_rate_based_threshold_with_minimum_calls(
...
class TestFallbackResult:
    ...
    def test_block_result(self):
        """Block 결과 생성."""
        result = FallbackResult.block("Service unavailable")
    ...
    def test_to_dlq_result(self):
        """DLQ fallback 결과 생성."""
        result = FallbackResult.to_dlq("Request queued")
...
class TestFallbackStrategies:
    ...
    def test_cache_fallback_miss_falls_back_to_block(
        self, mock_repository, mock_state
    ):
    ...
    def test_default_response_fallback_strategy(
        self, mock_repository, mock_state
    ):
...
class TestBurnRateMultiplier:
    ...
    def test_burn_rate_multiplier_uses_config_value(
        self, mock_repository, mock_state
    ):

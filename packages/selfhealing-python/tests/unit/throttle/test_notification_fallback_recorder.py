...
class TestNotificationFallbackRecorderFile:
    ...
    def test_record_multiple_entries(self):
        ...
        tmpdir = tempfile.mkdtemp()
        filepath = os.path.join(tmpdir, "test_multi.jsonl")
    ...
    def test_timestamp_iso_format(self):
        ...
        tmpdir = tempfile.mkdtemp()
        filepath = os.path.join(tmpdir, "test_ts.jsonl")
...
class TestNotificationFallbackRecorderMemory:
    ...
    def test_memory_entry_structure(self):
        ...
        assert entry["notification_type"] == "critical"
        assert entry["event_data"] == {"rtt": 500.0}
        assert entry["error"] == "Timeout"

    def test_file_write_success_does_not_buffer(self):

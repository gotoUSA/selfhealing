...
class TestResourceGuard:
    ...
    def test_cpu_threshold_blocks(self):
        ...
        # CPU 90%, 메모리 50% 시뮬레이션
        with patch.object(guard, "_get_cpu_percent", return_value=90.0), \
    ...
    def test_memory_threshold_blocks(self):
        ...
        # CPU 50%, 메모리 90% 시뮬레이션
        with patch.object(guard, "_get_cpu_percent", return_value=50.0), \
             patch.object(guard, "_get_memory_percent_cgroup", return_value=None), \
    ...
    def test_cgroup_priority(self):
        ...
        with patch.object(guard, "_get_cpu_percent", return_value=40.0), \
    ...
    def test_resource_check_disabled(self):
        ...
        # 설정에서 체크 비활성화
        with patch(
            "selfhealing.services.chaos.safety_guard.resource_guard.get_resource_guard_settings"
        ) as mock_settings:

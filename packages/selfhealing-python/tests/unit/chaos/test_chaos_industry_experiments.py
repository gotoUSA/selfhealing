...
class TestCertificateExpiryExperiment:
    ...
    def test_days_until_expiry_default(self):
        ...
        experiment = CertificateExpiryExperiment(config=ExperimentConfig(target_service="test"))
...
class TestClockSkewExperiment:
    ...
    def test_max_skew_seconds_constant(self):
        """Test MAX_SKEW_SECONDS hard cap constant exists in ExperimentHardCaps."""
    ...
    def test_skew_seconds_default(self):
        ...
        experiment = ClockSkewExperiment(config=ExperimentConfig(target_service="test"))
    ...
    def test_skew_seconds_hard_cap_positive(self):
        """Test ExperimentHardCaps.apply_cap caps skew_seconds at MAX."""
        from selfhealing.services.chaos.constants import ExperimentHardCaps

        capped = ExperimentHardCaps.apply_cap("clock_skew", "skew_seconds", 100000)
        assert capped == ExperimentHardCaps.CLOCK_SKEW_MAX_SECONDS

    def test_skew_seconds_hard_cap_negative(self):
        """Test apply_cap with negative skew_seconds returns the value as-is (min-based cap)."""
        from selfhealing.services.chaos.constants import ExperimentHardCaps

        # apply_cap uses min(value, cap), so negative values pass through
        capped = ExperimentHardCaps.apply_cap("clock_skew", "skew_seconds", -100)
        assert capped == -100
...
class TestDNSFailureExperiment:
    ...
    def test_default_failure_rate(self):
        ...
        experiment = DNSFailureExperiment(config=ExperimentConfig(target_service="test"))
...
class TestSimulatedDiskIOExperiment:
    ...
    def test_default_latency_ms(self):
        ...
        experiment = SimulatedDiskIOExperiment(config=ExperimentConfig(target_service="test"))
...
class TestSimulatedTLSFailureExperiment:
    ...
    def test_default_failure_rate(self):
        ...
        experiment = SimulatedTLSFailureExperiment(config=ExperimentConfig(target_service="test"))
...
class TestAuditStorageFailureExperiment:
    ...
    def test_default_failure_type(self):
        ...
        experiment = AuditStorageFailureExperiment(config=ExperimentConfig(target_service="test"))
...
class TestReplayFloodExperiment:
    ...
    def test_default_flood_rate(self):
        ...
        experiment = ReplayFloodExperiment(config=ExperimentConfig(target_service="test"))

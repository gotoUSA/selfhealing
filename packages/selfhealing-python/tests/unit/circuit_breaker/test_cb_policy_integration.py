...
class TestLayeredRepositorySlidingWindowBehavior:
    ...
    def test_default_sliding_window_size_passed_to_l1(self):
        ...
        from selfhealing.adapters.memory.layered_repository.base import (
...
class TestCircuitBreakerModuleExportsContract:
    ...
    def test_circuit_breaker_policy_importable(self):
        ...
        from selfhealing.services.circuit_breaker import CircuitBreakerPolicy
    ...
    def test_circuit_breaker_open_error_importable(self):
        ...
        from selfhealing.services.circuit_breaker import CircuitBreakerOpenError
    ...
    def test_circuit_breaker_decorator_importable(self):
        ...
        from selfhealing.services.circuit_breaker import circuit_breaker
    ...
    def test_imported_classes_are_correct_types(self):
        ...
        assert isinstance(CircuitBreakerPolicy.__init__, type(lambda: None).__class__) or True
        # CircuitBreakerPolicy가 클래스인지 확인
        policy = CircuitBreakerPolicy(service_name="test", cb_service=MagicMock(is_enabled=False))

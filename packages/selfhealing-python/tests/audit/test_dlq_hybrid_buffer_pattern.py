...
class TestDLQServiceWithRequest:
    ...
    def test_store_with_forensic_context_passes_request(self):
        """store_with_forensic_context signature includes request parameter."""
        from selfhealing.services.dlq_service import DLQService
        import inspect
        
        # Verify store_with_forensic_context has request parameter
        sig = inspect.signature(DLQService.store_with_forensic_context)
        params = list(sig.parameters.keys())
        
        assert "request" in params, "store_with_forensic_context should have request parameter"

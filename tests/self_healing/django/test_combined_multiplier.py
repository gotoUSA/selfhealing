...
class TestGetCombinedMultiplier:
    ...
    def test_combined_multiplier_basic(self):
        ...
        with patch.object(provider, "get_current_multiplier", return_value=1.0):
            # ErrorCode 가중치: SYSTEM_INTERNAL_ERROR = 1.0
            result = provider.get_combined_multiplier(error_code="SYSTEM_INTERNAL_ERROR")
    ...
    def test_combined_multiplier_max_policy(self):
        ...
        with patch.object(provider, "get_current_multiplier", return_value=5.0):
            # ErrorCode: SERVICE_TIMEOUT = 0.5
            with patch.dict(os.environ, {"SELFHEALING_WEIGHT_COMBINE_POLICY": "MAX"}):
                result = provider.get_combined_multiplier(error_code="SERVICE_TIMEOUT")
    ...
    def test_combined_multiplier_sum_policy(self):
        ...
        # EmergencyLevel = 3.0
        with patch.object(provider, "get_current_multiplier", return_value=3.0):
            ...
            with patch(
                ...
                with patch(
                    ...
                    result = provider.get_combined_multiplier(error_code="VALIDATION_FIELD_REQUIRED")
    ...
    def test_combined_multiplier_multiply_policy(self):
        ...
        # EmergencyLevel = 2.0
        with patch.object(provider, "get_current_multiplier", return_value=2.0):
            # get_weight_combine_policy와 get_weight_for_error_code를 직접 mock
            with patch(
                "selfhealing.services.error_budget.exception_weights.get_weight_combine_policy",
                ...
                with patch(
                    ...
                    result = provider.get_combined_multiplier(error_code="SERVICE_UNAVAILABLE")
    ...
    def test_combined_multiplier_respects_max_multiplier(self):
        ...
        with patch.object(provider, "get_current_multiplier", return_value=8.0):
    ...
    def test_combined_multiplier_without_error_code(self):
        ...
        with patch.object(provider, "get_current_multiplier", return_value=3.5):
...
class TestCombinedMultiplierWithRealTracker:
    ...
    def test_end_to_end_combined_multiplier(self):
        ...
        with patch.object(provider, "_get_emergency_tracker", return_value=mock_tracker):
            # NORMAL level = 1.0
            # SERVICE_CIRCUIT_OPEN = 0.3 (의도된 동작)
            result = provider.get_combined_multiplier(error_code="SERVICE_CIRCUIT_OPEN")

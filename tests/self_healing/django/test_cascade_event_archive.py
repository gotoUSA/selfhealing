"""
Cascade Event Archive Django 모델 통합 테스트.
...
실행 방법:
    docker-compose -f docker-compose.test.yml exec web pytest tests/self_healing/django/test_cascade_event_archive.py -v

Reference:
    packages/selfhealing-python/src/selfhealing/models/cascade_event_archive.py
"""
...
class TestCascadeEventArchiveModel:
    """CascadeEventArchive Django 모델 테스트."""
    ...
    def test_from_cascade_event_factory_method(self, mock_cascade_event):
        ...
        # 팩토리 메서드 호출 (구체 모델 사용)
        archive = CascadeEventArchive.from_cascade_event(mock_cascade_event)

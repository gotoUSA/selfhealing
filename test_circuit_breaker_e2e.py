    ...
    try:
        ...
        with stats_lock:
            ...
            if r.status_code == 200:
                stats["success_200"] += 1
                return {"status": 200, "time_ms": elapsed, "body": r.json() if r.headers.get('content-type', '').startswith('application/json') else r.text[:100]}
...
def print_stats():
    """현재 통계 출력"""
    print(f"   📊 총: {stats['total']}, 성공: {stats['success_200']}, "
